                  ...
                  <div class="userDrop">
                    ...
                    <div class="user-assets betweenSpread">
                      <div class="asset-box">
                        ...
                        <div class="leftSpread">
                          <el-input :type="showImg == true ? 'text' : 'password'" readonly v-model="totalAssets"></el-input>
                          <span>{{coinTxt == 'USDT' ? 'BTC' : 'USDT'}}</span></div>
                      </div>
                      <div class="leftSpread"><img @click="changeCoin" src="../assets/blocked.png" alt=""/><span>{{coinTxt}}</span>
                      </div>
                    </div>
                    <div class="user-order">
                      <div class="user-order-left">
                        <p>{{$t('assets.wallet')}}</p>
                        <router-link :to="{path:'assets',query:{type:1}}"><img src="../assets/recharge-icon.png"/>{{$t('assets.recharge')}}
                        </router-link>
                        <router-link :to="{path:'assets',query:{type:2}}"><img src="../assets/withdraw-icon.png"/>{{$t('assets.withdraw')}}
                        </router-link>
                        <router-link :to="{path:'assets',query:{type:4}}"><img src="../assets/record-icon.png"/>{{$t('assets.record')}}
                        </router-link>
                      </div>
                      <!--<div class="user-order-right">-->
                        <!--<p>{{$t('nav.order')}}</p>-->
                        <!--<router-link to="order"><img src="../assets/contact-icon.png"/>{{$t('contract.title')}}-->
                        <!--</router-link>-->
                      <!--</div>-->
                    </div>
                    <div class="userOUt leftSpread"><img src="../assets/out.png" alt=""/>
