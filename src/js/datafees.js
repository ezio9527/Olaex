...
class datafeeds {
	 ...
	 * @param {*String} resolution  分辨率,时间间隔
	 ...
	 */
	// +',resolution:'+resolution+',rangeStartDate:'+rangeStartDate+',rangeEndDate:'+rangeEndDate
	...
	defaultConfiguration() {
		return {
			...
			supported_resolutions: ['1', '5', '30', '60', '240', '1D','1W'],
			supports_marks: true,
