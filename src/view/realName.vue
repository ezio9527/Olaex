      ...
      <el-col :xs="24" :sm="24" :md="12" :lg="12">
        <el-form ref="form" :model="form">
          <div v-if="realStatus != 1 && realStatus != 2">
            <el-form-item :label="$t('person.realName')"
                          :rules="[{ required: true, message: $t('person.realNameEmpty')}]" prop="name">
              <el-input v-model="form.name" autocomplete="off" :placeholder="$t('person.realNameEmpty')">
              </el-input>
            </el-form-item>
            <el-form-item :label="$t('person.realNo')" :rules="[{ required: true, message: $t('person.realNoEmpty')}]"
                          prop="realNo">
          ...
          <el-button :disabled="realStatus == 0 ? false : true" class="themeBtn" @click="submit('form')">{{buttonTxt}}
          </el-button>
        </el-form>
      </el-col>
