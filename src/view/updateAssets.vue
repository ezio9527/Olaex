		...
		<el-row :gutter="60">
        	...
        	<el-col :xs="24" :sm="24" :md="12" :lg="12">
        		<el-form ref="form" :model="form">
	                <el-form-item :label="$t('recharge.asset')"  prop="newPwd" :rules="[{ required: true, message: $t('recharge.assetEmpty')},{pattern:/^[0-9]{6}$/,message:$t('form.assetsCruent'),trigger:'blur'}]">
	                    <el-input type="password" v-model="form.newPwd" autocomplete="off" :placeholder="$t('recharge.assetEmpty')">
	                    </el-input>
	                </el-form-item>
	                <el-form-item :label="$t('form.loginSurePwd')"  prop="sureNew" :rules="[{ required: true, message: $t('form.loginSureEmpty')},{pattern:/^[0-9]{6}$/,message:$t('form.assetsCruent'),trigger:'blur'}]">
	                    <el-input type="password" v-model="form.sureNew" autocomplete="off" :placeholder="$t('form.loginSureEmpty')">
	                    </el-input>
	                </el-form-item>
