  ...
  <div>
    <div class="formPage">
      ...
      <el-form :model="form" :rules="rules" ref="ruleForm">
        ...
        <el-form-item v-if="activeName == '0'" :rules="[{ required: true, message: $t('form.loginEmail')}]"
                      prop="email">
        ...
        <el-form-item prop="repwd">
          <el-input v-model="form.repwd" :type="showIcon2?'text':'password'" autocomplete="off"
        ...
        <p class="moveHand" style="text-align: right;"><a class="themeFont" @click="returnClose">{{$t('verification.return')}}</a>
        </p>
        <div>
          <el-button class="themeBtn" style="width: 100%;" @click="submitForget('ruleForm')">
            {{$t('verification.reset')}}
          </el-button>
          <p class="fontCenter">{{$t('form.noAccount')}}<a class="themeFont" @click="openRegister">{{$t('verification.registerName')}}</a>
          </p>
        </div>
      </el-form>
      <!--<AppTxt/>-->
